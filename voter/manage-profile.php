...
//Updating voter's information
$sql = mysqli_query($con,"UPDATE tbMembers SET first_name='$myFirstName', last_name='$myLastName' WHERE member_id = '$myId'" );

// redirect back to page
 header("Location: manage-profile.php");
}
//get voters inofrmation of the logged voter
...
<title>Electoral Poll: Update Profile</title>
