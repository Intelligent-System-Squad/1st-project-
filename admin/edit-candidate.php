...
//This checks whether your session is valid
...
?>
<?php
// This is to get the details of the voter we are going to edit.
$id=$_GET['id'];
$cn=$_GET['cn'];
$cp=$_GET['cp'];
?>
...
$CandName = addslashes( $_POST['cname'] ); //prevents types of SQL injection
$CandPosition = addslashes( $_POST['cposition'] ); //prevents types of SQL injection
 ...
 <div style="background-color: #B6AAAA; height: 700px; position: relative;">
            ...
            <div id="box">
                ...
                <form class="form" action="" method="post" >
                    ...
                    <input type="text" id="cname" name="cname" value="<?php echo $canName?>"><br><br>
                    <label for="lastname">Candidate Position</label>
                    <SELECT name="cposition" id="cposition">select
    <OPTION VALUE="select"><?php echo $canPosition?>
    <?php
