...
error_reporting(E_ALL);//Displays all type of errors
ob_start();//Capture and store output generated by the scripts and storing it temporaily before sending to the browser  
session_start();
require('../connection.php');

$tbl_name="tbAdministrators"; // inserts the admin table name into a variable 
...
//select all the rows which matches the username and password the user entered
