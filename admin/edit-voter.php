 ...
 <div style="background-color: #B6AAAA; height: 700px; position: relative;">
            ...
            <div id="box">
                ...
                <form class="form" action="" method="post" >
                    ...
                    <input type="text" id="f_name" name="f_name" value="<?php echo $votFirstName?>"><br><br>
                    <label for="lastname">Voter Last Name</label>
                    <input type="text" id="l_name" name="l_name" value="<?php echo $votLastName?>"><br><br>
                    <label for="lastname">Email</label>
                    <input type="text" id="eml" name="eml" value="<?php echo $votEmail?>"><br><br>
                    <label for="lastname">Password</label>
                    <input type="text" id="psw" name="psw" value="<?php echo $votPassword?>"><br><br>
