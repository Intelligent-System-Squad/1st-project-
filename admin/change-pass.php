  ...
  // This inserts all the values typed in the edit password form into the database after the button with the name updated is clicked  
  if (isset($_GET['id']) && isset($_POST['update']))
  {
      ...
      if($encPass==$mypassword)
      {
          if($newpass==$confpass)
          {
          $newpass = md5($newpass); //This will encrpyt your password into a md5, a high security hash
